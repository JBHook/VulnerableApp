...
-- Level 8: Strong, randomly-generated password + Bcrypt (not guessable via dictionary attack)
INSERT INTO auth_users VALUES (8, 'admin_weak', '$2a$10$7rGGurCrF/Br9UIZt2ol3OufhWLlGl9cbipAjFqyJI4eizX3qB6D2', NULL, 'BCRYPT', 8, 'admin_weak@example.com', 'ADMIN');
...
-- Level 10: BCrypt with a standard work factor (cost 10) and a strong random password
INSERT INTO auth_users VALUES (10, 'admin_lowcost', '$2a$10$VOauBL9X6swj4JYVDNSzZuanWOM56BToRIKSxl/bjGR7.Sq6pas3y', NULL, 'BCRYPT', 10, 'admin_lowcost@example.com', 'ADMIN');
